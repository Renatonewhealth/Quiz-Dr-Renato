...
interface AnimatedFolderButtonProps {
  onClick?: () => void;
  text?: string;
}

export function AnimatedFolderButton({ onClick, text = "INICIAR ANÁLISE" }: AnimatedFolderButtonProps) {
  return (
    <>
      <style jsx>{`
