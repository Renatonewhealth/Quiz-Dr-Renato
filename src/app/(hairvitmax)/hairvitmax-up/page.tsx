...
export default function HairvitmaxUpPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <link rel="preload" href="https://scripts.converteai.net/637f9657-7454-4e03-ad13-ab875efdb78d/players/6a0b74a6044ded98927cfe39/v4/player.js" as="script" />
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <section className="px-4 pt-3 pb-6">
          <p className="text-base sm:text-lg text-gray-700 text-center leading-relaxed">
            A Campanha <strong className="text-gray-900">&ldquo;Mês das Mães&rdquo;</strong> da H9 Pharma ainda não acabou, assista o vídeo abaixo para finalizar todas as etapas da compra e aprender como{' '}
        ...
        <section className="w-full">
          <div
            dangerouslySetInnerHTML={{
              __html: '<vturb-smartplayer id="vid-6a0b74a6044ded98927cfe39" style="display: block; margin: 0 auto; width: 100%; max-width: 400px;"></vturb-smartplayer>'
            }}
          />
          <Script
            src="https://scripts.converteai.net/637f9657-7454-4e03-ad13-ab875efdb78d/players/6a0b74a6044ded98927cfe39/v4/player.js"
            strategy="afterInteractive"
          />
          {/* Script de delay - libera a imagem do checkout após 549 segundos do vídeo */}
          <Script id="vturb-delay" strategy="afterInteractive">
            {`
              var delaySeconds = 549;
              ...
              __html: `
                <div style="text-align: center">
                  <a href="#" payt_action="oneclick_buy" data-object="453A8R-LY7JYA" style="display: block; margin: 0 auto; width: 78%; max-width: 380px; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.12);">
                    <img src="/images/desparafit-dia-das-maes.png" alt="2 Kits HairVitMax" style="width: 100%; display: block;" />
                  </a>
