...
/**
 * Downsell 1 do Korean — para quem veio de /koreanup1 (comprou 2 ou 3 kits
 * e recusou o upsell de +3 kits).
 * Oferece +1 Korean Kit por R$247 (69% off) via Payt one-click.
 *
 * One-click: como a navegação /koreanup1 → /koreandwns1 é same-origin via
 * <a href>, os cookies do Payt (setados no checkout inicial) persistem
 * intactos e o botão cobra sem re-pedir cartão.
 */
export default function KoreanDwns1Page() {
  const paytObj = 'LQDD6E-4EOQ3V';
  const ctaLabel = 'Sim, quero incluir mais 1 kit por R$247';
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="bg-gradient-to-br from-[#c4448f] to-[#a33575] text-white px-4 py-10 sm:py-14 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black leading-tight">
            ...
            <span className="text-white bg-black/20 px-2 py-0.5 rounded">69% de DESCONTO?</span>
          </h1>
        </div>
      </section>
      ...
      <article className="max-w-2xl mx-auto px-5 sm:px-6 py-8 sm:py-10 text-[17px] sm:text-lg leading-relaxed text-gray-800">
        ...
        <p className="mb-3">
          Você recusou os 3 kits. Tudo bem. <strong>Mas eu aconselho você pelo menos levar mais 1.</strong>
        </p>
        <p className="mb-3">Eu não vou insistir no pacote de 3 kits. Se não deu agora, não deu.</p>
        <p className="mb-6">
          Mas eu também não quero que você pare no meio do caminho só porque o valor apertou.
        </p>
        ...
        <div className="border-2 border-[#c4448f] rounded-2xl overflow-hidden bg-white shadow-xl my-8">
          <div className="bg-[#c4448f] text-white text-center py-3 sm:py-4">
            <p className="text-xl sm:text-2xl font-black uppercase tracking-wide">+ 1 Korean Kit</p>
          </div>
          <div className="px-6 py-6 text-center">
            <p className="text-sm text-gray-500 mb-1">
              De <span className="line-through">R$797</span> (preço normal no site) por
            </p>
            <p className="text-4xl sm:text-5xl font-black text-[#c4448f] my-2 leading-none">R$247</p>
            <p className="text-base sm:text-lg text-gray-700 font-semibold">à vista</p>
            <p className="text-base sm:text-lg text-gray-700">
              ou 12x de <strong>R$24,80</strong>
            </p>
        ...
        <p className="mb-3">
          Na página anterior, eram 3 kits por R$744, o que dá R$248 cada um.
        </p>
        <p className="mb-3">
          Aqui, o kit único sai por <strong>R$247</strong>.
        </p>
        <p className="mb-3">
          Isso é <strong className="text-[#c4448f]">69% de DESCONTO</strong>.
        </p>
        <p className="mb-3">
        ...
        <p className="mb-3">
          Continua com os cuidados direitinho, sem parar no meio do caminho, e acompanha.
        </p>
        <p className="mb-3">
        ...
        <p className="mb-6">
          Se você quiser incluir mais 1 kit do Korean Kit no seu pedido, é só tocar no botão abaixo.
        </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                    Um kit do Korean Kit custa <strong>R$797</strong> no site da H9 Pharma. Aqui, agora, ele sai por{' '}
                    <strong className="text-[#c4448f]">R$247</strong>. É o mesmo produto, a mesma fórmula, a mesma rotina. Você só está pagando menos porque está pegando ele aqui, junto com o seu pedido.
                  </p>
                </div>
              </div>
            </div>
