...
function destForSource(source: string | null): string {
  ...
  // Variante "sem tela" (abre direto no quiz) → VSL do vídeo 2 com src
  // próprio (quiz-fst-direct) pra separar a venda dessa variante.
  if (source === 'quiz-fst:direct') return '/quiz-fst-direct-vsl';
  return '/resultado2';
}
  ...
  if (showLeadForm) {
    return (
      <main className="min-h-screen bg-white">
        <div className="w-full max-w-[480px] mx-auto flex flex-col px-4 sm:px-6 pt-12 sm:pt-16 md:pt-20 pb-12 sm:pb-16 md:pb-20">
          {/* Header */}
