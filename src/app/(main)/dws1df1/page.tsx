 ...
 *
 * One-click: como a navegação de /up1df1 → /dws1df1 é same-origin via <a href>,
      ...
      <section className="bg-gradient-to-br from-[#2ec6a8] to-[#26a58c] text-white px-4 py-10 sm:py-14 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black leading-tight">
            ...
            <span className="text-white bg-black/20 px-2 py-0.5 rounded">70% de DESCONTO?</span>
          </h1>
        </div>
      </section>
      ...
      <article className="max-w-2xl mx-auto px-5 sm:px-6 py-8 sm:py-10 text-[17px] sm:text-lg leading-relaxed text-gray-800">
        ...
        <div className="border-2 border-[#2ec6a8] rounded-2xl overflow-hidden bg-white shadow-xl my-8">
          ...
          <div className="px-6 py-6 text-center">
            ...
            <p className="text-4xl sm:text-5xl font-black text-[#2ec6a8] my-2 leading-none">R$147</p>
        ...
        <p className="mb-3">
          Isso é <strong className="text-[#2ec6a8]">mais de 70% de DESCONTO</strong>.
        </p>
        <p className="mb-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                    ...
                    <strong className="text-[#2ec6a8]">R$147</strong>. É o mesmo produto, a mesma fórmula, o mesmo protocolo. Você só está pagando menos porque está pegando ele aqui, junto com o seu pedido.
                  </p>
                </div>
              </div>
            </div>
