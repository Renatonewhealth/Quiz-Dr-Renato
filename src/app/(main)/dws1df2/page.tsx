  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="bg-gradient-to-br from-[#14532d] to-[#0f3d21] text-white px-4 py-10 sm:py-14 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black leading-tight">
            ...
            <span className="text-[#c9a961]">73% de DESCONTO?</span>
          </h1>
        </div>
      </section>
      ...
      <article className="max-w-2xl mx-auto px-5 sm:px-6 py-8 sm:py-10 text-[17px] sm:text-lg leading-relaxed text-gray-800">
        ...
        <p className="mb-3">E é aí que entra a continuidade do tratamento.</p>
        <p className="mb-3">
        ...
        <div className="border-2 border-[#14532d] rounded-2xl overflow-hidden bg-white shadow-xl my-8">
          ...
          <div className="px-6 py-6 text-center">
            ...
            <p className="text-4xl sm:text-5xl font-black text-[#14532d] my-2 leading-none">R$267</p>
        ...
        <p className="mb-3">
          Isso é <strong className="text-[#14532d]">mais de 73% de DESCONTO</strong>.
        </p>
        <p className="mb-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                    ...
                    <strong className="text-[#14532d]">R$267</strong>. É o mesmo produto, a mesma fórmula, o mesmo protocolo. Você só está pagando menos porque está pegando ele aqui, junto com o seu pedido.
                  </p>
                </div>
              </div>
            </div>
