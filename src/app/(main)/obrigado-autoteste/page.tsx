...
export default function ObrigadoAutotestePage() {
  return (
      ...
      <div className="max-w-2xl mx-auto px-6">
        ...
        <section className="pb-4">
          <h1 className="text-2xl sm:text-3xl font-black text-center text-[#2ec6a8] leading-tight">
            🎉 Obrigado por garantir o Auto-teste personalizado + Protocolo do Dr. Renato! 🎉
          </h1>
        </section>

        {/* Sub-headline com instruções do WhatsApp */}
        <section className="pb-8">
          <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 space-y-4">
            <p className="text-base sm:text-lg text-gray-700 text-center leading-relaxed">
              Seu pedido foi confirmado com sucesso. Agora é só aguardar — em instantes, nossa equipe vai te chamar no{' '}
              <strong className="text-[#25D366]">WhatsApp</strong> para dar continuidade no seu atendimento personalizado.
            </p>
            <div className="flex items-center justify-center gap-2 text-sm text-gray-500 pt-2">
              ...
              <span>Fica de olho no seu WhatsApp</span>
            </div>
          </div>
        </section>
      </div>
